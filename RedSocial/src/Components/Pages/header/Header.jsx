        ...
        <>
            <nav className='Header'>
                ...
                <Link to="/perfil">
                    ...
                    <Button ancho="25" altura="65" borderRadius="3px" color="#C5C5C5" colorLetra="#000000"><Link to="/Configuracion"><img className='rueda' src={Engranaje} alt="Imagen de la tarjeta" /></Link></Button>
                </div>
            </nav>
        </>
     );
